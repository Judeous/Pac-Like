...
int main()
{
	...
	Maze::TileKey s = Maze::TileKey::SUMMONER;
	...
	Maze::TileKey emptierMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ _, _, _, _, _, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, s, _, _, _, _, _ },
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
	...
	game.setCurrentScene(game.addScene(new Maze(emptierMap)));
